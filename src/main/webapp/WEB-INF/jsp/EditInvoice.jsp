                        ...
                        <c:choose>
                          <c:when test="${invoice.status == 1}">
                            <div class="btn-wrapper">
                              ...
                              <span class="tooltip"
                                >ไม่สามารถแก้ไขได้ เนื่องจากชำระเงินแล้ว</span
                              >
                            </div>
                          </c:when>
                          <c:otherwise>
                            <a
                              href="EditInvoiceFormFull?invoiceId=${invoice.invoiceId}"
                              class="btn btn-edit"
                        ...
                        <c:choose>
                          <c:when test="${invoice.status == 1}">
                            <div class="btn-wrapper">
                              ...
                              <span class="tooltip"
                                >ไม่สามารถลบได้ เนื่องจากชำระเงินแล้ว</span
                              >
                            </div>
                          </c:when>
                          <c:otherwise>
