                            ...
                            <div class="reservation-card">
                              ...
                              <div class="card-body">
                                ...
                                <div class="info-row">
                                  ...
                                  <span class="info-value">
                                    <fmt:formatDate value="${reserve.reserveDate}" pattern="dd/MM/yyyy HH:mm" />
                                  </span>
                                </div>
                                ...
                                <div class="info-row">
                                  ...
                                  <span class="info-value">
                                    <fmt:formatDate value="${reserve.checkInDate}" pattern="dd/MM/yyyy" />
                                  </span>
                                </div>
                                ...
                                <div class="info-row">
                                  ...
                                  <span class="info-value">
                                    <c:choose>
                                      <c:when test="${rentStatusMap[reserve.reserveId] == 'คืนห้องแล้ว'}">
                                        <span class="status-badge status-rejected">
                                          <i class="fas fa-undo"></i> คืนห้องแล้ว
                                        </span>
                                      </c:when>
                                      <c:when test="${rentStatusMap[reserve.reserveId] == 'เช่าอยู่'}">
