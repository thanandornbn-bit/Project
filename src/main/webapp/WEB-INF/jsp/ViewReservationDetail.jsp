              ...
              <div class="info-grid">
                ...
                <div class="info-section">
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value"
                      >${rent.member.firstName} ${rent.member.lastName}</span
                    >
                  </div>
                  <div class="info-item">
                    <span class="info-label">
                ...
                <c:if test="${not empty rent.rentalDeposit}">
                  <div class="info-section">
                    ...
                    <div class="info-item">
                      ...
                      <span class="info-value"
                        >${rent.rentalDeposit.transferAccountName}</span
                      >
                    </div>
                    <div class="info-item">
                      <span class="info-label">
                      ...
                      <span class="info-value">
                        <fmt:formatDate
                          value="${rent.rentalDeposit.paymentDate}"
                          pattern="dd/MM/yyyy"
                        />
                      </span>
                    </div>
                    <div class="info-item">
                      ...
                      <span class="info-value">
                        <fmt:formatDate
                          value="${rent.rentalDeposit.deadlineDate}"
                          pattern="dd/MM/yyyy"
                        />
                      </span>
                    </div>
                    <div class="info-item">
                      ...
                      <span class="info-value"
                        >฿<fmt:formatNumber
                          value="${rent.rentalDeposit.totalPrice}"
                          groupingUsed="true"
                      /></span>
                    </div>
                    <div class="info-item">
                      ...
                      <span class="info-value">
                        <c:choose>
                          ...
                          <c:when
                            test="${rent.rentalDeposit.status == 'รอดำเนินการ'}"
                          >
                ...
                <div class="slip-section">
                  ...
                  <c:choose>
                    <c:when
                      test="${not empty rent.rentalDeposit.paymentSlipImage}"
                    >
                      <div class="slip-image-container">
                        <img
                          src="${pageContext.request.contextPath}/${rent.rentalDeposit.paymentSlipImage}"
                          class="slip-image"
                          alt="สลิปการโอนเงิน"
          ...
          <div class="detail-card">
            ...
            >
              <i
                ...
                style="font-size: 4rem; color: #ff4444; margin-bottom: 20px"
              ></i>
              <h3 style="color: #ff8c00; margin-bottom: 15px">
                ไม่พบข้อมูลการจอง
              </h3>
              <p style="color: #999; margin-bottom: 30px">
                ระบบไม่สามารถค้นหาข้อมูลการจองที่ต้องการได้
              </p>
              <a href="OViewReserve" class="btn btn-back">
                <i class="fas fa-arrow-left"></i>
                กลับไปรายการจอง
