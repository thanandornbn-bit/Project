<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="jakarta.tags.core" %>
    <%@ page import="com.springmvc.model.*" %>
      <% Member loginMember=(Member) session.getAttribute("loginMember"); boolean isLoggedIn=(loginMember !=null); %>
        ...
        <body>
          ...
          <div class="fullscreen-overlay" id="fullscreenOverlay" onclick="closeFullscreen()">
            ...
            <img src="" alt="ดูภาพขนาดเต็ม" class="fullscreen-image" id="fullscreenImage" />
          </div>
                  ...
                  <c:choose>
                    <c:when test="${not empty room.roomImage1}">
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/RoomImage?roomId=${room.roomID}&imageType=1"
                    ...
                    <c:otherwise>
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/image/tc1.jpg"
                  ...
                  <c:choose>
                    <c:when test="${not empty room.roomImage2}">
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/RoomImage?roomId=${room.roomID}&imageType=2"
                    ...
                    <c:otherwise>
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/image/tc2.jpg" alt="ห้องพัก - ระเบียงพร้อมมุมครัว"
                  ...
                  <c:choose>
                    <c:when test="${not empty room.roomImage3}">
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/RoomImage?roomId=${room.roomID}&imageType=3"
                    ...
                    <c:otherwise>
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/image/tc3.jpg" alt="ห้องพัก - ลิฟต์อาคาร"
                  ...
                  <c:choose>
                    <c:when test="${not empty room.roomImage4}">
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/RoomImage?roomId=${room.roomID}&imageType=4"
                    ...
                    <c:otherwise>
                      <div class="gallery-item"
                        ...
                        <img src="${pageContext.request.contextPath}/image/tc4.jpg" alt="ห้องพัก - มุมมองห้องทั้งหมด"
