    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                ...
                <strong>หมายเหตุ:</strong> Email ไม่สามารถแก้ไขได้ | หากไม่ต้องการเปลี่ยนรหัสผ่านให้เว้นว่างไว้
            </div>
            ...
            <form name="formEditProfile" action="Editprofile" method="post" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback" id="firstNameError">กรุณากรอกชื่อ</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback" id="lastNameError">กรุณากรอกนามสกุล</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phoneNumber" name="phoneNumber" value="<%= member.getPhoneNumber() %>" 
                           required pattern="^0[0-9]{9}$" maxlength="10" placeholder="0812345678">
                    <div class="invalid-feedback" id="phoneError">กรุณากรอกเบอร์โทรศัพท์ 10 หลัก (ขึ้นต้นด้วย 0)</div>
                    <div class="valid-feedback" id="phoneValid">เบอร์โทรศัพท์ถูกต้อง</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input type="password" id="password" name="password" placeholder="กรอกรหัสผ่านใหม่ถ้าต้องการเปลี่ยน">
                        <i class="fas fa-eye password-toggle" id="togglePassword"></i>
                    </div>
                    <div class="invalid-feedback" id="passwordError">รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input type="password" id="confirmPassword" name="confirmPassword" placeholder="ยืนยันรหัสผ่านใหม่">
                        <i class="fas fa-eye password-toggle" id="toggleConfirmPassword"></i>
                    </div>
                    <div class="invalid-feedback" id="confirmPasswordError">รหัสผ่านไม่ตรงกัน</div>
                    <div class="valid-feedback" id="confirmPasswordValid">รหัสผ่านตรงกัน</div>
                </div>
