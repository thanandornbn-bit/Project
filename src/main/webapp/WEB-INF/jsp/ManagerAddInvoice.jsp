...
uri="jakarta.tags.core" prefix="c" %> <%@ taglib prefix="fmt"
uri="jakarta.tags.fmt"%> <%@ page session="true"%> <%@ page
import="com.springmvc.model.Manager"%> <% Manager loginManager = (Manager)
              ...
              <div class="room-info-card">
                ...
                <div class="room-info-grid">
                  <div class="room-info-item">
                    <strong
                      ><i class="fas fa-door-open"></i> หมายเลขห้อง</strong
                    >
                  ...
                  <div class="room-info-item">
                    <strong
                      ><i class="fas fa-money-bill-wave"></i> ราคาห้อง</strong
                    >
                    <span
                      >฿<fmt:formatNumber
                  ...
                  <div class="room-info-item">
                    <strong
                      ><i class="fas fa-info-circle"></i> สถานะห้อง</strong
                    >
                ...
                <div class="form-section">
                  ...
                  <div class="utility-section">
                    ...
                    <div class="utility-card">
                      ...
                      <div class="calculation-display">
                        <div>รวมค่าไฟฟ้า</div>
                        <div class="amount" id="electricityTotalDisplay">
                          ฿0.00
                        </div>
                      </div>
                    </div>
    ...
    <script>
      ...
      function calculateTotal() {
        try {
          ...
          let internetPrice =
            parseFloat(document.getElementById("internetPrice").value) || 0;
          let penalty =
            parseFloat(document.getElementById("penalty").value) || 0;

          let prevWater =
            parseFloat(document.getElementById("prevWater").value) || 0;
          let currWater =
            parseFloat(document.getElementById("currWater").value) || 0;
          let waterRate =
            parseFloat(document.getElementById("waterRate").value) || 0;
          let waterUsage = Math.max(0, currWater - prevWater);
          let waterTotal = waterUsage * waterRate;

          const waterDisplayElement =
            document.getElementById("waterTotalDisplay");
          if (waterDisplayElement) {
            waterDisplayElement.textContent = "฿" + waterTotal.toFixed(2);
          }

          let prevElectric =
            parseFloat(document.getElementById("prevElectric").value) || 0;
          let currElectric =
            parseFloat(document.getElementById("currElectric").value) || 0;
          let electricRate =
            parseFloat(document.getElementById("electricRate").value) || 0;
          let electricUsage = Math.max(0, currElectric - prevElectric);
          let electricityTotal = electricUsage * electricRate;

          const electricDisplayElement = document.getElementById(
            "electricityTotalDisplay"
          );
          if (electricDisplayElement) {
            electricDisplayElement.textContent =
              "฿" + electricityTotal.toFixed(2);
          }

          let total =
            roomPrice + internetPrice + waterTotal + electricityTotal + penalty;
          ...
          if (totalDisplayElement) {
            totalDisplayElement.textContent =
              "฿" +
      ...
      function validateForm() {
        ...
        if (currWater < prevWater) {
          showToast(
            "หน่วยน้ำปัจจุบันต้องมากกว่าหรือเท่ากับหน่วยเดือนก่อน",
            "error"
          );
          return false;
        }
        ...
        if (currElectric < prevElectric) {
          showToast(
            "หน่วยไฟปัจจุบันต้องมากกว่าหรือเท่ากับหน่วยเดือนก่อน",
            "error"
          );
          return false;
        }
      ...
      function validateForm() {
        ...
        if (currWater < prevWater) {
          alert(
            "❌ เลขมิเตอร์น้ำปัจจุบัน (" +
              currWater +
              ") ต้องมากกว่าหรือเท่ากับเดือนก่อน (" +
              prevWater +
              ")"
          );
