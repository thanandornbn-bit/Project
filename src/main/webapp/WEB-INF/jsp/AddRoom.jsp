        ...
        <div class="container">
          ...
          <div class="form-card">
            ...
            <div class="card-body">
              ...
              <!-- Add Room Form -->
              <form action="AddRoom" method="post" id="addRoomForm" enctype="multipart/form-data">
                <!-- Room Info -->
                  ...
                  <div class="form-grid">
                    <div class="form-group">
                      ...
                      <input type="text" id="roomNumber" name="roomNumber" class="form-control" required
                        placeholder="เช่น 101, 102, 103" pattern="[0-9]{3,4}" maxlength="3" />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="roomtype" name="roomtype" class="form-control" value="ห้องแอร์" readonly
                ...
                <div class="form-section">
                  ...
                  <div class="form-grid">
                    <div class="form-group">
                      ...
                      <input type="number" id="roomPrice" name="roomPrice" class="form-control" required
                        placeholder="3000" min="1000" max="50000" step="100" />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="roomStatus" name="roomStatus" class="form-control" value="ว่าง" readonly
                        style="background: rgba(0, 0, 0, 0.6)" />
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="roomDeposit" name="roomDeposit" class="form-control" required
                    placeholder="กรุณากรอกค่ามัดจำห้อง" min="500" value="500" />
                </div>
