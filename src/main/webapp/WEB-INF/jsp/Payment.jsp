...
import="com.springmvc.model.*"%> <%@ page import="java.util.*,
java.text.SimpleDateFormat"%> <% Member loginMember = (Member)
session.getAttribute("loginMember"); Room reservedRoom = (Room)
request.getAttribute("room"); Date today = new Date(); SimpleDateFormat sdf =
new SimpleDateFormat("dd/MM/yyyy", new Locale("th", "TH")); String todayStr =
sdf.format(today); %>
<!DOCTYPE html>
<html lang="th">
  <head>
