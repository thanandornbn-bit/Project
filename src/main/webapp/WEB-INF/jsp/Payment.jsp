...
<%
    ...
    Room room = (Room) request.getAttribute("room");  // ✅ เปลี่ยนจาก reservedRoom เป็น room
    Date today = new Date();
    ...
    <div class="header">
      ...
      <div class="user-section">
        <div class="user-info">
          ...
          <span>
            <%=loginMember !=null ? loginMember.getFirstName() + " " +
            loginMember.getLastName() : "" %>
          </span>
        </div>
      </div>
    </div>
        ...
        <div class="payment-card">
          ...
          <div class="qr-section">
            ...
            <div class="qr-code-container">
              <img
                src="https://promptpay.io/${manager.promptPayNumber}/${room.roomDeposit}.png"
                alt="QR Code PromptPay"
              />
            </div>
            <div class="qr-info">
              <p>
                <strong>หมายเลข PromptPay:</strong>
                <c:out value="${manager.promptPayNumber}" />
              </p>
              <p>
                <strong>ชื่อบัญชี:</strong>
                <c:out value="${manager.accountName}" />
              </p>
          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <input
                ...
                placeholder="กรอกชื่อบัญชีที่ใช้โอนเงิน"
                required
              />
            </div>
