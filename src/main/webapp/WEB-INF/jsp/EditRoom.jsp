    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                ...
                <span>กรุณากรอกข้อมูลให้ครบถ้วนและถูกต้อง ข้อมูลที่มีเครื่องหมาย <span style="color: #ff4444;">*</span> จำเป็นต้องกรอก</span>
            </div>

            <div class="room-info">
                <div class="room-info-item">
                    <span class="room-info-label"><i class="fas fa-hashtag"></i> รหัสห้อง:</span>
                    <span class="room-info-value">${room.roomID}</span>
                </div>
            </div>

            <form action="UpdateRoom" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               required/>
                        <div class="invalid-feedback" id="roomNumberError">กรุณากรอกเลขห้อง</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="roomtype" id="roomtype" required>
                            ...
                            <option value="พัดลม" ${room.roomtype == 'พัดลม' ? 'selected' : ''}>พัดลม</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback" id="priceError">กรุณากรอกราคาห้องที่ถูกต้อง</div>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="invalid-feedback" id="descriptionError">กรุณากรอกคำอธิบาย</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (roomNumber.value.trim() === '') {
                ...
                roomNumber.classList.add('is-valid');
